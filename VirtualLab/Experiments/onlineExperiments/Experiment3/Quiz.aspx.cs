...
namespace VirtualLab.Experiments.onlineExperiments.Experiment3
{
    public partial class Quiz : System.Web.UI.Page
    {
        ...
        {
            xDoc.Load((String)ViewState["path"]);
        ...
        protected void SelectionList_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (SelectionList.SelectedIndex == 0)
            {
                strXmlFilePath = System.Web.HttpContext.Current.Server.MapPath("preExperimentQuiz.xml");
            }
            else
            {
                strXmlFilePath = System.Web.HttpContext.Current.Server.MapPath("postExperimentQuiz.xml");
            }
            ViewState.Add("path", strXmlFilePath);
            SelectionList.Items[0].Selected = false;
            SelectionList.Items[1].Selected = false;
