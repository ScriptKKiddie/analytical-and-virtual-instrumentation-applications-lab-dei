<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="procedure.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment6.procedure" %>
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    <div style="padding-left: 40px;">
                        <ul>
                            <li>Adjust all three electrode system and attach with MUX module</li>
                            <li>Attach DropSens GC and MWCNT to its transducers</li>
                            <li>The parameters given below are filled in the page displayed after initializing the
                                concerned software.
                                <div style="padding-left: 40px;">
                                <ul>
                                    <li>The supporting electrolyte solution (2 ml K<sub>3</sub>[Fe (CN)<sub>6</sub>] + 4
                                        ml KCl + 14 ml distilled water) is filled into the cell.</li>
