<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sample.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment4.sample" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    <p>
                        Ten tablets of crocin were weighed and then powdered. 0.1 g of powdered tablets
                        was weighed accurately and placed in a 250 ml conical flask. 50 ml of warm water
                        was added into the flask. The sample was swirled to dissolve for 30 minutes and
                        left cool. The sample solution was filtered through a filter paper (Whatman No.42)
                        into a 100 ml volumetric flask. The filtrate was made upto the volume.
                    </p>
                </div>
                <br />
                <br />
