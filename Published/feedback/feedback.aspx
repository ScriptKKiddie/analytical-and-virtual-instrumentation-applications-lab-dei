<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback.aspx.cs" Inherits="VirtualLab.feedback.feedback" %>
...
<body>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LABConnectionString %>"
        DeleteCommand="DELETE FROM [feedback] WHERE [sno] = @sno" InsertCommand="INSERT INTO [feedback] ([name], [expname], [ques1a], [ques1b], [ques1c], [ques1d], [ques1e], [ques1f], [ques1g], [ques1h], [coment], [ques2], [ques3], [ques4], [ques5], [ques6], [mail], [userId]) VALUES (@name, @expname, @ques1a, @ques1b, @ques1c, @ques1d, @ques1e, @ques1f, @ques1g, @ques1h, @coment, @ques2, @ques3, @ques4, @ques5, @ques6, @mail, @userId)"
        SelectCommand="SELECT * FROM [feedback]" UpdateCommand="UPDATE [feedback] SET [name] = @name, [expname] = @expname, [ques1a] = @ques1a, [ques1b] = @ques1b, [ques1c] = @ques1c, [ques1d] = @ques1d, [ques1e] = @ques1e, [ques1f] = @ques1f, [ques1g] = @ques1g, [ques1h] = @ques1h, [coment] = @coment, [ques2] = @ques2, [ques3] = @ques3, [ques4] = @ques4, [ques5] = @ques5, [ques6] = @ques6, [mail] = @mail, [userId] = @userId WHERE [sno] = @sno">
        <DeleteParameters>
            ...
            <div class="entry">
                ...
                <table cellpadding="10px">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="273px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox3" runat="server" Height="22px" Width="277px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox2" runat="server" Height="20px" Width="329px" Text="Analytical & Virtual Instrumentation Applications Lab"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownList1" runat="server" Height="21px" Width="375px">
                                <asp:ListItem>Study of Electrochemical Technique, Cyclic Voltammery</asp:ListItem>
                                ...
                                <asp:ListItem>Amperometric Determination of Hydrogen Peroxide</asp:ListItem>
                ...
                <table cellpadding="10px">
                    ...
                    <tr align="center">
                        ...
                        <td class="space">
                            <asp:RadioButton ID="RadioButton1" runat="server" GroupName="first" Checked="true" />
                        </td>
                        <td class="space">
