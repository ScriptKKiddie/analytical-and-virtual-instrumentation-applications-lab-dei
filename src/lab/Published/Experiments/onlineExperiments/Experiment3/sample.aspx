<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sample.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment3.sample" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    <p>
                        Unknown - The unknown or the juices (fruits) can be used for the ascorbic acid determination.
                        The process involves plotting the standards (diff. conc.) of Ascorbic Acid with
                        peak current and tracing the amount of ascorbic acid present in the sample.</p>
                    <p>
                        Direct loading of the sample on the working surface of the electrode can be done.
                    </p>
                </div>
                <br />
                <br />
