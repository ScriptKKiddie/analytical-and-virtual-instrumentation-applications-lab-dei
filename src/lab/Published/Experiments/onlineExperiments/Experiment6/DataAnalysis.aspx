<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataAnalysis.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment6.DataAnalysis" %>
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    <table border="1">
                        <thead>
                            <tr>
                                <th>
                                 ...
                                 <th>
                                    Max Peak Current (Ipa)
                                </th>
                           
                                <th>
                                    Min Peak Current (Ipc)
                                </th>
                           
                                <th>
                                    Max Peak Potential (Epa)
                                </th>
                        
                                <th>
                                    Min Peak Potential (Epc)
                                </th>
                        ...
                        <tr>
                            <td>
                                DropSens GC(Channel 1)
                            </td>
                            <td>
                                0.00021 A
                            </td>
                            <td>
                                -7.299×10<sub>-5</sub>V
                            </td>
                            <td>
                                0.312 V
                            </td>
