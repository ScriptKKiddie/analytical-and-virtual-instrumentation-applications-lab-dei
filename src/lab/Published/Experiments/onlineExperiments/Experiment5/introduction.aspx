<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="introduction.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment5.Introduction" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    ...
                    <br />
                    <p>
                        Determination of heavy metals in water sample by square wave stripping voltammetric
                        technique using boron doped diamond electrode.
                    </p>
                    <br />
                    <h1>
                        Introduction</h1>
                    <br />
                    <p>
                        Exposure to high levels of trace metal ions (eg. Cd<sup>2+</sup>, Cu<sup>2+</sup>
                        and Pb<sup>2+</sup>) poses a variety of health problem because they tend to accumulate
                        in the body, are toxic and have low rate of clearance. Therefore it is critical
                        to minimize the exposure of humans to these contaminants and this can be ensured
                        through effective water quality monitoring.
                    </p>
                    <p>
                        There are several methods available for the determination of trace metal ions which
                        include atomic absorption spectroscopy, inductively coupled plasma mass spectrometry,
                        HPLC and ASV, among these methods ASV is commonly employed because of tit’s wide
                        linear dynamic range, low detection limit and multi elemental analysis capability.</p>
                    <p>
                        Moreover the use of boron doped diamond electrode over GCE result in increase in
                        the current response indicating that the electron transfer kinetics is higher with
                        BDDE and thus improving the sensitivity for the measurement of the metal ions in
                        water samples.</p>
                    <p>
                        Boron doped diamond electrode is highly electrically conducting with an average
                        electrical resistivity of 0.75 X 10<sup>-3</sup>Ωm. when employed in electrochemistry,
                        boron-doped diamond exhibits interesting kinetic effects due to electronic/ chemical
                        state of the surface.</p>
                </div>
                <br />
                <br />
            </div>
