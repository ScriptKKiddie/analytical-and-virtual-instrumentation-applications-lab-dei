<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="VirtualLab._Default" %>
        ...
        <div style="background-image: url(images/content_bg.jpg); position: relative; margin: auto;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <h2 class="title" align="center">
                    <a href="#">An Introduction</a></h2>
                <p class="meta">
                    <a href="#"></a>&nbsp;&nbsp; <a href="#" class="comments"></a>
                </p>
                <div style="padding:10px 30px 5px 30px; font-size: medium; line-height: 22px;">
                    <p>
                    ...
                    <p>
                        ...
                        <br /><br />
                        <h3 style="color:Black;">Objective</h3><br />
                        <ul type="1">
                        <li style="line-height:35px;">To learn the basic concepts related to Analytical Chemistry.</li>                        
                        <li>To share costly equipment and resources, which are otherwise available to limited number of users due to constraints on time and geographical distances.</li>               
                        </ul>
                </div>
                <br />
                <br />
