<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataAnalysis.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment1.DataAnalysis" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <p style="text-align:center;">
                    <img alt="Analysis" src="Images/analysis.jpg" />
                </p><br />
                 <p><b>Effect of sweep rate:</b>  Faster sweep rates generate steeper concentration gradients at the electrode surface, causing large peak currents. This is because faster scan rates cause the same amount of charge to be passed in a shorter period of time. Because current is ratio of charge to time, a faster sweep rate gives a larger current. The system is reversible, as the potential difference comes out to be 65 mV. </p><br />
                 <p><b>Effect of concentration:</b>  The larger current will be observed during the experiment roughly estimated by multiplying the electrode area by the solution concentration. </p><br />
                 <p><b>Diffusion Current:</b>  This current is an interfering current therefore electrolyte like KCl is added to neutralize the current. KNO3 can also be used in its place. </p><br />
                </div>
                <br />
                <br />
            </div>
