<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="VirtualLab.others.ContactUs" %>
    ...
    <div style="background-image: url(../images/content_bg.jpg); position: relative;
        ...
        <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
            ...
            <div class="entry" align="center" style="font-size: medium;">
                <b>Dr. Soami P. Satsangee</b>
                <br />
                Incharge, USIC<br />
                Dayalbagh Educational University, Agra<br />
                Email : deiusic@gmail.com
                <br />
                Ph : +91-9760230620<br />
                +91-9219975356
            </div>
