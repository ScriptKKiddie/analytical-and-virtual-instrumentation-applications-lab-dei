<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="perform.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment4.perform" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    ...
                    <br />
                    <p>
                        <b>Step -1.</b> Open PINE WAVENOW - Software. Click On the icon Below.</p>
                    <center>
                        <a href="aftermath.zip">
                            <img src="Images/Step4a.jpg" alt="Icon" /></a></center>
                    <br />
                    <p>
                    ...
                    <br />
                    <p>
                        <b>Step -4</b> Open the DRP dialog box</p>     
                        <center>             
                            <img src="Images/Step5a.jpg" alt="Step4" width="800px"/>
                        
                    </center>
                    <br />
                    <p>
                        <b>Step -5</b> Click on the NEW PROCEDURE in the File Option and select the Differential Pulse Voltammetry technique.</p><br />
                    <center>
                        <img src="Images/Step6a.jpg" alt="Step5" width="800px"/></center>
                         <br />
                    <p>
                        <b>Step -6</b> Fill the given Parameters and RUN the Experiment</p><br />
                    <center>
                        <img src="Images/Step7a.jpg" alt="Step5" width="800px" /></center>
                        <br />
                         <p>
                        <b>Step -1.</b> Open Dropview - Software. Click On the icon Below.</p>
                    <center>
                        <a href="Nova.zip">
                    ...
                    <p>
                        <b>Step -4</b> Open the DRP dialog box</p>     
                        <center>             
                            <img src="Images/Step4b.jpg" alt="Step4" width="800px" />
                    ...
                    <p>
                        <b>Step -5</b> Click on the NEW PROCEDURE in the File Option and select the Differential Pulse Voltammetry technique.</p><br />
                    <center>
                        <img src="Images/Step5b.jpg" alt="Step5" width="800px"/></center>
                         <br />
                    <p>
                        <b>Step -6</b> Fill the given Parameters and RUN the Experiment</p><br />
                    <center>
                        <img src="Images/Step6b.jpg" alt="Step5" width="800px"/></center>
