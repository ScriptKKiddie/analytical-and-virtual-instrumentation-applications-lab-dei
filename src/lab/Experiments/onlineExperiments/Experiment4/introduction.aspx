<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="introduction.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment4.introduction" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    ...
                    <br />
                    <p>
                        Comparative Study the Electrochemical Assay of Acetaminophen in Paracetamol Tablet
                        using DropSens Multi Walled Carbon Nano Tube (MWCNT) Screen Printed Electrodes and
                        Glassy Carbon Screen Printed Electrodes.</p>
                    <br />
                    <h1>
                        Introduction</h1>
                    <br />
                    <p>
                        Paracetamol (PCT) is also known as acetaminophen (N acetyl- p-aminophenol or 4-acetamidophenol).
                        It is a major ingredient in numerous cold and influenza medications. PCT is also
                        an effective and safe analgesic agent and is consequently used worldwide for the
                        relief of mild to moderate pain associated with, e.g., headache, toothache, backache,
                        arthritis, migraine, neuralgia, muscular aches, menstrual cramps, and postoperative
                        pain.
                        <br />
                    </p>
                    <br />
                    <p style="text-align: center;">
                        <img alt="Introduction Image" src="Images/intro.jpg" align="center" />
                        <br />
                    </p>
                    <br />
                    <p>
                        Many assays have been described for acetaminophen including titrimetry, chromatography
                        , fluorometry, colorimetry, UV spectrophotometry, and various
                        modes of electrochemistry. Although the electrochemical oxidation of paracetamol
                        at a glassy carbon electrode has been in the literature for some time only
                        a few applications of its use in differential pulse voltammetry have been reported;
                        for determination of the drug in blood plasma and in a single type of tablet
                        and in a variety of drug formulations containing paracetamol.
                    </p>
                    <p>
                        Crocin contains paracetamol / acetaminophen, is an analgesic (pain killer) and an
                        antipyretic (fever reducer), used to treat fever, headache and body pains.
                    </p>
                </div>
                <br />
                <br />
