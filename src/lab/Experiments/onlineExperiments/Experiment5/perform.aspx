<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="perform.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment5.perform" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    ...
                    <br />
                    <p>
                        <b>Step -1.</b> Open the NOVA Software, CLICK ON the Icon Below.</p><br />
                    <center>
                        <a href="Nova.zip">
                    ...
                    <br />
                    <p>
                        <b>Step -4</b> NOVA Software Opens</p><br />
                    <center>
                            <img src="Images/Step4.jpg" alt="Step4" /></center>
                        <br />
                    <p>
                        <b>Step -5</b> Select Square Wave Voltammetric Technique And Fill The Parameters</p><br />
                    <center>
                        <img src="Images/Step5.jpg" alt="Step5" /></center>
                        <br />
                    <p>
                        <b>Step -6</b> Run the Experiment</p><br />
                    <center>
