<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sample.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment5.sample" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">                   
                    <br />                 
                    <ul>
                        <li>Standard metal solutions  of Pb(NO<sub>3</sub>)<sub>2</sub>, Cd(NO<sub>3</sub>)<sub>2</sub> & Cu(NO<sub>3</sub>)<sub>2</sub> are prepared.</li>
                        <li>0.2M of CH<sub>3</sub>COOH and CH<sub>3</sub>COONa are prepared and then 87.3 and 12.7ml of CH<sub>3</sub>COOH and CH<sub>3</sub>COONa respectively are mixed to get the acetate buffer of 4.2pH.</li>
                        <li>1M HNO for cleaning and activating the boron doped diamond electrode.</li>
                        <li>0.1M KNO<sub>3</sub>  to be used as the supporting electrolyte.</li>
                    </ul>
                    <br />
