<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="video.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment5.video" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="padding: 10px 0px 10px 15px; text-align:center;">                    
                    <iframe width="640" height="385" src="http://www.youtube.com/embed/hMzjyubdl7I" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
            <br />
            <br />
