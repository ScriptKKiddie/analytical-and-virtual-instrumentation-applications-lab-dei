<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="introduction.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment6.introduction" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    ...
                    <br />
                    <p>
                        Elctrochemical study of ferricyanide /ferrocyanide system at four different electrode
                        surfaces with MUX MULTI4.</p>
                    <br />
                    <h1>
                        Theory</h1>
                    <br />
                    <br />
                    <p>
                        Cyclic voltammetry (CV) is a versatile electroanalytical technique for the study
                        of electro-active species. CV monitors redox behavior of chemical species within
                        a wide potential range. The current at the working electrode is monitored as a triangular
                        excitation potential is applied to the electrode. The resulting voltammogram can
                        be analyzed for fundamental information regarding the redox reaction. Cyclic voltammograms
                        are the electrochemical equivalent to the spectra in optical spectroscopy.
                    </p>
                    <br />
                    <p>
                        The potential at the working electrode (WE) is controlled vs a reference electrode
                        (RE), Ag/AgCl(s)/ (satd. KCl) electrode. The controlling potential that is applied
                        across the WE and the auxiliary electrodes is the excitation signal. The excitation
                        signal is varied linearly with time; first scan positively (-100 mV to 500 mV vs
                        RE). Then the potential is scanned in reverse, causing a negative scan back to the
                        original potential to complete the cycle. Single or multiple cycles can be used
                        on the same surface. A cyclic voltammogram is the plot of the response current at
                        the working electrode to the applied excitation potential.
                    </p>
                    <br />
                    <p>
