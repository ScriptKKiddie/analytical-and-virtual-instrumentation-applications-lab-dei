<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="video.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment6.video" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="padding: 10px 0px 10px 15px; text-align:center;">
                    ...
                    <param name="movie" value="http://www.youtube.com/v/8e5QNw1hgVg?fs=1&amp;hl=en_US&amp;rel=0"></param>
