<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sample.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment6.sample" %>
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    <div style="padding-left: 40px;">
                        <ul type="1">
                            <li>K<sub>4</sub>Fe(CN)<sub>6</sub> – 0.2 g in 100ml of water</li>
                            <li>K<sub>3</sub>[Fe(CN)<sub>6</sub>] – 0.17 g in 100ml of water</li>
                            <li>KCl – 3.7 g in 100ml of water </li>
                        </ul>
                    </div>
                    <br />
                    <p>
                        <b>Note:</b> It is important that glassware is cleaned thoroughly, rinsed several
                        times with pure water and then dried prior to use.</p>
                </div>
                <br />
                <br />
            </div>
