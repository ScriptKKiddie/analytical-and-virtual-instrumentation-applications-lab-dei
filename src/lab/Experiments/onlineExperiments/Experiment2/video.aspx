<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="video.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment2.video" %>
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="padding: 10px 0px 10px 15px; text-align:center;">
                    <object width="640" height="385">
                        <param name="movie" value="http://www.youtube.com/v/LPPhrYP0vP0?fs=1&amp;hl=hi_IN" />
                        
                        <param name="allowFullScreen" value="true" />
                        <param name="allowscriptaccess" value="always" />
                        <embed src="http://www.youtube.com/v/LPPhrYP0vP0?fs=1&amp;hl=hi_IN" type="application/x-shockwave-flash"
