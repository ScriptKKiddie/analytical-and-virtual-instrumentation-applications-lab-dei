<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="animate.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment2.animate" %>
...
<form id="form1" runat="server">
    ...
    <div id="no_print">
        ...
        <div style="position: relative; margin: auto; width: 1024px; background-color: #e3f2fc">
            <br />
            <span class="title">Animate Instrument</span>
        </div>
        <div id="no_print">
        </div>
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry">
                    <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0"
                        width="950" height="650" id="polorography" align="middle">
                        <param name="allowScriptAccess" value="sameDomain" />
                        <param name="movie" value="../../SimulationData/Polarography/polorography.swf" />
                        <param name="quality" value="high" />
                        <param name="salign" value="lt" />
                        <param name="bgcolor" value="#ffffff" />
                        <embed src="../../SimulationData/Polarography/polorography.swf" quality="high" salign="lt"
                            bgcolor="#ffffff" width="950" height="650" name="polorography" align="middle"
