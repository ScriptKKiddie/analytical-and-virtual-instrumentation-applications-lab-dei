<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quiz.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment2.Quiz" %>
        ...
        <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
         <br />
           <div id="ddtabs2" class="glowingtabs">
            ...
            <div class="entry" style="font-size: 10pt; font-family: verdana,helvetica,arial,sans-serif; color:#000000;">
...
<span id="QuizScreen" runat="server" visible="false">
<table width="100%" border="0" cellpadding="2" cellspacing="0">
  <tr class="heading">
    <td width="50%" align="left"><font color="#284E98"><b>Electro Chemistry Quiz</b></font></td>
	<td width="50%" align="right"><font color="#284E98"><b>Virtual Labs Quiz</b></font></td>
  </tr>
  <tr>
    <td colspan="2">
	  <b><asp:label id="lblQuestion" runat="server" /></b><br /><br />
      <asp:radiobuttonlist
	     id="rblAnswer"
  ...
  <tr class="heading">
    <td width="50%" align="left"><font color="#284E98"><b>Total <asp:label id="lblTotalQuestion" runat="server" /> questions</b></font></td>
	<td width="50%" align="right"><font color="#284E98"><b>Time spent <asp:label id="lblTimeSpent" runat="server" /></b></font></td>
  </tr>
</table>
</span>
