<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="introduction.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment3.Introduction" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    ...
                    <br />
                    <p>
                        To Study and Develop the Method for Electrochemical Behaviour and the Effect of
                        pH Variance on Ascorbic Acid using Dropsens Electrodes via Dropsens Potentiostat.</p>
                    <br />
                    <h1>
                        Introduction</h1>
                    <br />
                    <p>
                        Ascorbic acid is a highly effective antioxidant and is used widely as a food additive.
                        Ascorbic acid or Vitamin C determination methods are helpful in the quality control
                        of the food industry and are fast, simple, selective and highly sensitive. The methods
                        are based on the electrochemical oxidation of ascorbic acid to the dehydroascorbic
                        acid.
                        <br />
                    </p>
                    <br />
