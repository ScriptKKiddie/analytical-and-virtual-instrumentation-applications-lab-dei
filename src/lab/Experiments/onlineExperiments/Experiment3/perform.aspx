<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="perform.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment3.perform" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    ...
                    <br />
                    <p>
                        <b>Step -1.</b> Open DropView - Software. Click On the icon Below.</p><br />
                    <center>
                        <a href="DropView.zip">
                            <img src="Images/Step1.jpg" alt="Icon" /></a></center>
                    <br />
                    <p>
                        <b>Step -2.</b> Establish the connection with SERVER</p><br />
                    <center>
                        <img src="Images/Step2.jpg" alt="Step2" /></center>
                    <br />
                    <p>
                        <b>Step -3</b> Enter Your Username & Password</p><br />
                    <center>
                        <img src="Images/Step3.jpg" alt="Step3" /></center>
                    <br />
                    <p>
                        <b>Step -4</b> DropView Software opens</p><br />
                    <center>
                            <img src="Images/Step4.jpg" alt="Step4" /></center>
                        <br />
                    <p>
                        <b>Step -5</b> Click on the NEW PROCEDURE in the File Option and select the Cyclic Voltammetry technique.</p><br />
                    <center>
                        <img src="Images/Step5.jpg" alt="Step5" /></center>
                        <br />
                    <p>
                        <b>Step -6</b> Fill the given parameters and RUN the experiment.</p><br />
                    <center>
                            <img src="Images/Step6.jpg" alt="Step6" /></center>
                        <br />
                         <p>
                        <b>Step -7</b> Autoscale or Manually Edit axis for Interpretation of Voltammogram.</p><br />
                    <center>
                            <img src="Images/Step7.jpg" alt="Step7" /></center>
                        <br />
                         <p>
                        <b>Step -8</b> For superimposing and comparison select LOAD CURVES in File Menu.</p><br />
                    <center>
                            <img src="Images/Step8.jpg" alt="Step8" /></center>
                        <br />
                         <p>
                        <b>Step -9</b> Select the overlaying graph from the window appeared.</p><br />
                    <center>
                            <img src="Images/Step9.jpg" alt="Step9" /></center>
                        <br />
                         <p>
                        <b>Step -10</b> Different scans can be relatively compared by the superimposition.</p><br />
                    <center>
                            <img src="Images/Step10.jpg" alt="Step10" /></center>
                        <br />
                </div>
                <br />
                <br />
