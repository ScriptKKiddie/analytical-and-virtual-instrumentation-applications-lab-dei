<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reference.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment3.reference" %>--%>
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    ...
                    <h1>References:</h1>
                       <ul type="*">
                            ...
                            <li>Ascorbic Acid Determination in Commercial Fruit Juice Samples by Cyclic Voltammetry
Aurelia Magdalena Pisoschi,Andrei Florin Danet, and Slawomir Kalinowski Journal of Automated Methods and Management in Chemistry
Volume 2008 (2008), Article ID 937651, 8 pages
http://dx.doi.org/10.1155/2008/937651. </li>    
                        </ul>
                    </div>
                </div>
                <br />
