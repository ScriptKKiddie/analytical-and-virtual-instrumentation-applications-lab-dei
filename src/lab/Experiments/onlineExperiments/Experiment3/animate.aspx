<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="animate.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment3.animate" %>
    ...
    <div id="no_print">
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style=" padding-top:20px; text-align: center;">
                    
                    <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0"
                         width="940" height="600" id="drop sens" align="middle">
                        <param name="allowScriptAccess" value="sameDomain" />
                        <param name="movie" value="../../../Simulations/dropsens.swf" />
                        <param name="quality" value="high" />
                        <param name="bgcolor" value="#666699" />
                        <embed src="../../../Simulations/dropsens.swf" quality="high" bgcolor="#666699"  width="940" height="600"
                            name="drop sens" align="middle" allowscriptaccess="sameDomain" type="application/x-shockwave-flash"
