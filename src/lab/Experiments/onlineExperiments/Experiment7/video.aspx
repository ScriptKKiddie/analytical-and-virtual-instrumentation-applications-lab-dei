<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="video.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment7.video" %>
    ...
    <div id="no_print">
        ...
        <div id="header">
            <ul id="menuTop" style="font-size: x-small; font-weight: 700;">
                ...
                <li><a href="../../../loginschedule/login.aspx" target="_self" id="loginschedule"
                    runat="server">Login & Schedule</a></li>
            ...
            margin: auto; width: 1024px; min-height: 400px;">
               ...
               <div class="entry" style="padding: 10px 0px 10px 15px; text-align: center;">
                    <object width="640" height="385">
                        <param name="movie" value="http://www.youtube.com/v/8e5QNw1hgVg?fs=1&amp;hl=en_US&amp;rel=0">
                        </param>
                        <param name="allowFullScreen" value="true"></param>
                        <param name="allowscriptaccess" value="always"></param>
                        <embed src="http://www.youtube.com/v/8e5QNw1hgVg?fs=1&amp;hl=en_US&amp;rel=0" type="application/x-shockwave-flash"
