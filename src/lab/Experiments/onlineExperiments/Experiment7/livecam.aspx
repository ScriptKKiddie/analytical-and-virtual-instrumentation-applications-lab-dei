<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="livecam.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment7.livecam" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
         ...
         <script type="text/javascript">
             ...
             height_array[1] = 480;
                     ...
                     <img id="webcam1" alt="Live Stream" class="webcam" height="480" 
                         onmousedown="PTZMouseDown1(event)" src="http://220.227.100.58:8080/loading.jpg" 
                         width="640" />
<script type="text/javascript">
<!--
    currentCamera1 = 1;
...
<script type="text/javascript">
    ...
    height_array[2] = 480;
                     ...
                     <img id="webcam2" alt="Live Stream" class="webcam" height="480" 
                         onmousedown="PTZMouseDown2(event)" src="http://220.227.100.58:8080/loading.jpg" 
                         width="640" />
<script type="text/javascript">
<!--
    currentCamera2 = 2;
...
<script type="text/javascript">
    ...
    height_array[3] = 480;
                     ...
                     <img id="webcam3" alt="Live Stream" class="webcam" height="480" 
                         onmousedown="PTZMouseDown3(event)" src="http://220.227.100.58:8080/loading.jpg" 
                         width="640" />
<script type="text/javascript">
<!--
    currentCamera3 = 3;
...
<script type="text/javascript">
    ...
    height_array[4] = 480;
                     ...
                     <img id="webcam4" alt="Live Stream" class="webcam" height="480" 
                         onmousedown="PTZMouseDown4(event)" src="http://220.227.100.58:8080/loading.jpg" 
                         width="640" />
<script type="text/javascript">
<!--
    currentCamera4 = 4;
