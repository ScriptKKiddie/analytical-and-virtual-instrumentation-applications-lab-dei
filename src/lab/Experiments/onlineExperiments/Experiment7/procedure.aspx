<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="procedure.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment7.procedure" %>
    ...
    <div id="no_print">
        ...
        <div id="header">
            <ul id="menuTop" style="font-size: x-small; font-weight: 700;">
                ...
                <li><a href="../../../loginschedule/login.aspx" target="_self" id="loginschedule">Login & Schedule</a></li>
                ...
                <p class="meta">
                 ...
                 <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    <div style="padding-left: 40px;">
                        <ul type="1">
                            <li><b>Solution preparation:</b> Connection of Dummy cell.</li><br />
                            <img id="imageCDDummy" alt="loading..." src="images/ECDummy.JPG" height="85" width="200" />
                            <li><b>Parameters:</b></li>
                            <li><table>
                            <tr>
                            <td>First Applied Frequency</td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp; 1,00,000 Hz </td>
                            </tr>
                            <tr>
                            <td>Last Applied Frequency</td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0.1 Hz</td>
                            </tr>
                            <tr>
                            <td>No of frequency </td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;50</td>
                            </tr>
                            <tr>
                            <td>Amplitude</td>
