<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sample.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment1.sample" %>
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    <div style="padding-left: 40px;">
                        <ul type="1">
                            <li>KCl, 1M- Dissolve 18.5 gms of KCl in 250 ml of water. Water and KCl should be free
                                from contaminants.</li>
                            <li>K<sub>3</sub>[Fe(CN)<sub>6</sub>], 10 mM - Add 0.329 gms of potassium ferricyanide
                                in 100ml of pure ionized water. </li>
                                <li>Prepare 0.0001 M Dopamine Hydrochloride in Phosphate Buffer solution. </li>
                        </ul>
                    </div>
                </div>
                <br />
