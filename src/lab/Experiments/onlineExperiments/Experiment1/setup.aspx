<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="setup.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment1.setup" %>
    ...
    <div id="no_print">
        ...
        <div id="header">
            <ul id="menuTop" style="font-size: x-small; font-weight: 700;">
                ...
                <li><a href="../../../feedback/Feedbaks.aspx" target="_self">Feedback</a></li>
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    ...
                    <div style="padding-left: 40px;">
                        <ul>
                            ...
                            <li>Pt, Au, GC electrodes can be as working electrodes.</li>
                        </ul>
                    </div>
                    <br />
                    ...
                    <div style="padding-left: 40px;">
                        <ul type="1">
                            <li>KCl, 1M</li>
                            <li>K<sub>3</sub>[Fe(CN)<sub>6</sub>], 10 mM</li>
