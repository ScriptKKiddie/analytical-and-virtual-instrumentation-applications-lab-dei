<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="video.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment1.video" %>
    ...
    <div id="no_print">
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry">
                    <asp:LinkButton ID="lnkBtnBasicVideo" runat="server" 
                        onclick="lnkBtnBasicVideo_Click"> <h3 style="text-decoration:underline;">1. Basics of Cyclic Voltammetry - Theoretical</h3></asp:LinkButton><br />
                                        <asp:LinkButton ID="lnkBtnAdvncVideo" runat="server" 
                        onclick="lnkBtnAdvncVideo_Click" >
<h3 style="text-decoration:underline;">2. Cyclic Voltammetry of Ferricyanide solution using KCl as supporting electrolyte - Practical</h3></asp:LinkButton> <br />
               <div style="padding: 10px 0px 10px 15px; text-align:center;">
               
                   <asp:Panel ID="basicVideo" runat="server" Visible="false">
                  
                <iframe width="560" height="349" id="videoFrame" src="http://www.youtube.com/embed/K9jnznGIF1Q" frameborder="0" allowfullscreen="1"></iframe>
                 </asp:Panel>
                  <asp:Panel ID="avdnvVideo" runat="server" Visible="false">
                <iframe width="560" height="349" src="http://www.youtube.com/embed/OUu5bhGGjj8" frameborder="0" allowfullscreen="1"></iframe> 
                </asp:Panel>
                </div>
                </div>
            </div>
