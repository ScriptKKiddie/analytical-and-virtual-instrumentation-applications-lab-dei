<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="animate.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment1.animate" %>
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div id="ddtabs2" class="glowingtabs">
                    <ul>
                        ...
                        <li><a href="livecam.aspx"><span>
                         ...
                         <%--<li><a href="#"><span>
                            <center>
                                <img src="../../../Images/reference.gif" border="0"><br />
                                References</center>
                        </span></a></li>--%>
                    </ul>
                </div>
                ...
                <div style="text-align:center;">
                    <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0"
                        width="700" height="600" id="polorography" align="middle">
                        <param name="allowScriptAccess" value="sameDomain" />
                        <param name="movie" value="../../../Simulations/nova.swf" />
                        <param name="quality" value="high" />
                        <param name="salign" value="lt" />
                        <embed src="../../../Simulations/nova.swf" quality="high" salign="lt"
                            width="700" height="600" name="polorography" align="middle"
