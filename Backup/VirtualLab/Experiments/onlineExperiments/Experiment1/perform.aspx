<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="perform.aspx.cs" Inherits="VirtualLab.Experiments.onlineExperiments.Experiment1.perform" %>
        ...
        <div style="background-image: url(../../../images/content_bg.jpg); position: relative;
            ...
            <div id="contentBox" style="padding: 0px; padding-left: 50px; padding-right: 50px;">
                ...
                <div class="entry" style="line-height: 22px; font-size: medium; padding: 0px 0px 10px 15px;">
                    ...
                    <br />
                    <p>
                        <b>Step -1.</b> Open Nova - Software. Click On the icon Below.</p>
                    <center>
                        <a href="Nova.zip">
                    ...
                    <p>
                        <b>Step -5</b> CLICK the START button and observe the peaks in “DATA PRESENTATION”
                        window.</p><br />
                    <center>
